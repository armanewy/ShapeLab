...
use orchard_asset::{AssetRecipe, OperationId, PartDefinitionId, PartInstanceId, RegionId};
use orchard_poly::ElementId;
...
pub fn write_model_package_with_dcc_options(
    ...
    let manifest = AssetManifest {
        ...
        generator: "orchard-compile model export".to_owned(),
        source_recipe_hash,
