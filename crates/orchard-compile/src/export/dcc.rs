...
pub struct DccVariantControl {
    ...
    /// Display value.
    pub value: String,
    /// Whether this control was locked in the Object Orchard source.
    pub locked: bool,
}
...
pub struct DccAdapterFiles {
    ...
    /// Serialized Object Orchard source recipe.
    pub recipe: String,
    /// DCC rebuild helper.
...
pub fn dcc_rebuild_script() -> &'static str {
    r####"# Generated by Object Orchard DCC output adapter.
import argparse
import json
...
fn validate_dcc_manifest(
    ...
    if adapter.source_of_truth != DccSourceOfTruth::default() {
        return Err(super::invalid_package(
            context,
            "DCC adapter must keep Object Orchard package as source of truth",
        ));
    }
