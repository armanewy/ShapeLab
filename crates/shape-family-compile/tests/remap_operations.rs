...
use shape_family_compile::remap::FragmentRemapError;
use shape_family_compile::remap::ids::prepare_fragment_id_remap;
use shape_family_compile::remap::operations::{
...
fn missing_reference_errors_include_fragment_and_operation_context() {
    let mut remap = shape_family_compile::remap::FragmentRemap::default();
    ...
    let error = remap_modeling_operation(
        ...
        &shape_family_compile::remap::FragmentRemap::default(),
    )
