...
fn semantic_clay_docs_keep_preview_display_separate_from_material_support() {
    ...
    assert!(!shape_foundry::FoundryPreviewDisplayMode::DiagnosticPartColor.default_novice_safe());
...
fn screenshot_state_assertions_cover_required_make_scenarios() {
    ...
    let sphere =
        ready_fixture_state_test_app(shape_foundry_catalog::sphere_primitive::fixture_catalog())
            .make_canvas_view_state();
    assert!(
...
fn lidded_box_make_baseline_flow_is_plain_and_complete() {
    ...
    let adjust_effects = app
        ...
        .handle_command(FoundryAppCommand::run(FoundryCommand::SetControl {
            ...
            value: shape_foundry::ControlValue::Scalar(0.8),
        }))
    ...
    assert_eq!(
        ...
        Some(&shape_foundry::ControlValue::Scalar(0.8))
    );
...
fn sphere_primitive_make_baseline_flow_is_plain_and_complete() {
    ...
    let preset_commands = shape_foundry_catalog::sphere_primitive::knob_like_form_preset_values()
        .into_iter()
...
fn handled_panel_make_baseline_flow_is_plain_and_complete() {
    ...
    let adjust_effects = app
        ...
        .handle_command(FoundryAppCommand::run(FoundryCommand::SetControl {
            ...
            value: shape_foundry::ControlValue::Scalar(0.85),
        }))
    ...
    assert_eq!(
        ...
        Some(&shape_foundry::ControlValue::Scalar(0.85))
    );
...
fn ready_visible_state_test_app() -> FoundryDesktopApp {
    ready_fixture_state_test_app(shape_foundry_catalog::box_primitive::fixture_catalog())
}
