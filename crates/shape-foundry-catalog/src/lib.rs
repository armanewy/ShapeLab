...
pub fn built_in_catalog_curation_metadata() -> Vec<CatalogCurationMetadata> {
    vec![
        ...
        CatalogCurationMetadata {
            ...
            has_readable_control_evidence: true,
            has_human_showcase_review: false,
            note: "Sci-Fi Crate is default-visible only for current dogfood regression continuity; Simple Crate becomes the first novice crate after its own baseline passes.",
        },
        CatalogCurationMetadata {
