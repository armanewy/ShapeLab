...
fn user_summary_markdown(
    summary: &orchard_foundry::ObjectPlanUserSummary,
...
fn materialized_user_summary_markdown(
    summary: &orchard_foundry::MaterializedObjectSummary,
...
struct ObjectPlanMaterializationReport {
    ...
    unresolved_nodes: Vec<orchard_foundry::UnresolvedObjectPlanNode>,
    unresolved_attachments: Vec<orchard_foundry::UnresolvedObjectPlanAttachment>,
