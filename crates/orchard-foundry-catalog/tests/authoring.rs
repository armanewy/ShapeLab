...
use orchard_foundry::CATALOG_LOCK_KEY_CUSTOMIZER_PROFILE;
...
fn built_in_fixtures_round_trip_through_author_packages() {
    for fixture in headless_fixture_catalogs() {
        ...
        let output = orchard_foundry::compile_foundry_document(&packaged.document, &packaged)
...
fn author_package_writes_exact_local_catalog() {
    ...
    let document: orchard_foundry::FoundryAssetDocument =
