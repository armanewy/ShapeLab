...
use orchard_project::foundry::{FoundryProjectFile, FoundryProjectLoadReport};
use orchard_render::{Aabb, clay_readability_render_settings, fit_camera_to_bounds, render_mesh};
...
pub(crate) struct FoundryPreviewImage {
    ...
    pub camera: orchard_render::OrbitCamera,
...
impl FoundryAppState {
    ...
    pub(crate) fn request_preview(
        ...
        width: u32,
        height: u32,
        camera: Option<orchard_render::OrbitCamera>,
    ) -> Result<Vec<FoundryAppEffect>, FoundryAppStateError> {
...
fn focused_candidate_request_from_command(
    group_id: String,
    channels: Vec<orchard_foundry::VariationChannel>,
    mode: String,
) -> FoundryCandidateRequest {
    ...
    let channels = if channels.is_empty() {
        vec![orchard_foundry::VariationChannel::Shape]
    } else {
        channels
    };
    FoundryCandidateRequest {
        ...
        strategy_id: None,
        preference_profile: None,
        variation_intent: orchard_foundry::VariationIntent {
...
fn current_control_value(
    document: &FoundryAssetDocument,
    control: &orchard_foundry::CustomizerControl,
...
fn option_cards_for_control(
    control: &orchard_foundry::CustomizerControl,
    domain: &orchard_foundry::FeasibleControlDomain,
...
struct OptionCardContext<'a> {
    domain: &'a orchard_foundry::FeasibleControlDomain,
...
struct OptionPreviewImage {
    ...
    width: u32,
    height: u32,
    camera: orchard_render::OrbitCamera,
}
...
mod tests {
    ...
    fn test_candidate_card(id: &str, selectable: bool) -> FoundryCandidateCard {
        FoundryCandidateCard {
            ...
            width: 0,
            height: 0,
            camera: Some(orchard_render::OrbitCamera::default()),
