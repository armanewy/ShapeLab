...
impl FamilyStudioLiteSource {
    ...
    fn property_exposures(self) -> Vec<orchard_foundry::DirectKitPropertyExposure> {
        match self {
            Self::Primitive(primitive_kind) => {
...
const PREVIEW_CATALOG_ENV_VAR: &str = "OBJECT_ORCHARD_PREVIEW_CATALOG";
const OBJECT_PLAN_REVIEW_ENV_VAR: &str = "OBJECT_ORCHARD_OBJECT_PLAN_REVIEW";
const FAMILY_STUDIO_LITE_ENV_VAR: &str = "OBJECT_ORCHARD_FAMILY_STUDIO_LITE";
const LEGACY_CANDIDATE_UI_ENV_VAR: &str = "OBJECT_ORCHARD_LEGACY_CANDIDATE_UI";
