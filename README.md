...
Start with [`docs/README.md`](docs/README.md). It is the active documentation
index and the policy boundary for deleted obsolete reports.

The shortest status path is:

- [`docs/CURRENT_PRODUCT_STATUS.md`](docs/CURRENT_PRODUCT_STATUS.md)
- [`docs/KNOWN_LIMITATIONS.md`](docs/KNOWN_LIMITATIONS.md)
- [`docs/ARCHITECTURE_STATUS.md`](docs/ARCHITECTURE_STATUS.md)
