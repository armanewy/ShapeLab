...
| --- | --- | --- | --- | --- | --- |
| Visual Foundry built-in profiles | Generate, customize, pack, export | Create asset family | Not an import path | `shape-foundry`, `shape-family-compile`, `shape-compile` | Automated gates cover eleven authored profiles; default novice exposure is review-gated |
