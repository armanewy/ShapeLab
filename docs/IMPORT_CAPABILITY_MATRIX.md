...
| --- | --- | --- | --- | --- | --- |
| Visual Foundry built-in profiles | Generate, customize, pack, export | Create asset family | Not an import path | `shape-foundry`, `shape-family-compile`, `shape-compile` | Product-ready for the three authored profiles |
