...
- Box Primitive does not approve cloud, collaboration, or telemetry features.
- Box Primitive does not approve material-look persistence.
- Box Primitive does not approve pack-level publishing.
