...
family-maturity rung. Sci-Fi Crate may remain visible only while current dogfood
evidence says it is non-regressed. If that evidence is stale or failing, Sci-Fi
Crate moves to the preview/developer catalog until the regression baseline is
restored.
