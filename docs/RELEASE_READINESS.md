...
- the Visual Foundry product gate. Without `--verify-visual-gate`, this records
  ...
  CLI evidence for seventeen profiles, seven primary controls per profile, and
...
- the Visual Foundry product UI gate. Without `--verify-product-ui-gate`, this
  ...
  inventory, direct nonblank startup, zero default-visible pending kits, seventeen
...
The release gate also requires all seventeen built-in profiles to compile and render
...
- zero default-visible pending kits and seventeen installed preview-catalog kits;
