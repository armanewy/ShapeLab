...
- Historical note: Asset Modeling Lab was implemented as a native app mode in
  Wave 6, but Wave 31 removed that product surface. The explicit asset recipe
  lane remains in core/headless crates and docs as modeling architecture, not as
  the current native UI.
